...
type StudentCourseSubjectSubmissionAttemptRepository interface {
	Save(ctx context.Context, studentCourseSubjectSubmissionAttempt entity.StudentCourseSubjectSubmissionAttempt) error
