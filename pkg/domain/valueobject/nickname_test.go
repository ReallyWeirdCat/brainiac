...
func TestNewNickname(t *testing.T) {
	...
	tests := []struct {
		...
		},
		{
			...
			want:    Nickname("a23456789012345678901234567890"),
			wantErr: false,
		},
		{
