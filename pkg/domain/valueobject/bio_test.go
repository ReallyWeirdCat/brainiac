...
func TestNewBio(t *testing.T) {
	...
	tests := []struct {
	...
	}{
		{
			...
			want:    Bio{value: "Hello, I am a software engineer."},
			wantErr: false,
		},
		{
		...
		},
		{
			...
			want:    Bio{value: "http is a protocol and https is secure"},
			wantErr: false,
		},
		{
			name:    "only @ symbol",
